...
import (
	...
	"github.com/john/internal/controller"
...
func init() {
	...
	utilruntime.Must(johnv1beta1.AddToScheme(scheme))
...
func main() {
	...
	options := ctrl.Options{
		...
		LeaderElectionID:       "f4dc636b.john.tech",
	...
	if os.Getenv("ENABLE_WEBHOOKS") != "false" {
		if err = (&johnv1beta1.App{}).SetupWebhookWithManager(mgr); err != nil {
